...
const Launchpad = () => {
  return (
    <section id='launchpad' className='my-40 android:mt-16'>
        <UseSectionHeader text='LAUNCHPAD////' />
        <div className="grid grid-cols-2 tablet:flex tablet:flex-col order-[-1] tablet:gap-y-8">
            <div className="tablet:order-1 flex flex-col gap-y-12 laptop:gap-y-8 android:gap-y-4 pr-40 laptop:pr-28 ipad:pr-16 tablet:pr-0 justify-center">
                <p className="font-neubit text-primary font-bold text-4xl ipad:text-3xl phablet:text-2xl uppercase">GENESIS</p>
                ...
                <button className="flex bg-primary w-full ipad:w-[80%] tablet:w-full mt-12 ipad:mt-6 relative">
                    ...
                    <p className="text-dark font-bold text-5xl p-3 pb-[7px] laptop:text-4xl ipad:text-3xl laptop:p-2 laptop:pb-[3px] ipad:pb-1 text-nowrap mx-auto font-neubit">LAUNCH ON GENESIS</p>
                </button>
            </div>
            <div className="grid-lines tablet:col-span-2">
                <div className="border-[2px] border-primary bg-green-bg h-[50vw] laptop:h-[45vw] ipad:h-[40vw] tablet:h-[60vw] phablet:h-[80vw] max-h-[650px] w-full px-12 pt-12 laptop:p-8 android:p-6 relative">
                    ...
                    <div className="justify-between flex items-center">
                        <span className="text-white text-2xl laptop:text-lg ipad:text-base font-bold uppercase font-neubit">WHERE DID THE MEME START?</span>
                        <span className="text-white text-2xl laptop:text-lg ipad:text-base font-bold uppercase font-neubit">TEST HERE</span>
                    </div>
                </div>
            </div>
        </div>
